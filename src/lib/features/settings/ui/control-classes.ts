...
export const controlInputSpaceClass = "w-full sm:min-w-[16rem] sm:max-w-[22rem]";
...
export const controlButtonMdClass =
  "inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-zinc-300 bg-white px-3 text-sm font-semibold text-zinc-700 shadow-sm transition hover:border-zinc-400 hover:text-zinc-900 disabled:cursor-not-allowed disabled:opacity-60";

export const controlButtonMdFullClass = `${controlButtonMdClass} w-full`;

export const controlButtonSmClass =
  "inline-flex h-8 items-center justify-center rounded-md border border-zinc-300 bg-white px-2.5 text-xs font-semibold text-zinc-700 transition hover:border-zinc-400 hover:text-zinc-900 disabled:cursor-not-allowed disabled:opacity-60";
