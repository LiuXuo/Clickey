...
const en: Record<TranslationKey, string> = {
  ...
  "playground.title": "Bubble Playground",
  "playground.prompt.ready": "Click to start",
  "playground.prompt.active": "Listening for keys",
  "playground.prompt.continue": "Keep narrowing the region",
  "playground.prompt.resume": "Click to resume",
  "playground.result.success": "Bubble popped",
  "playground.result.miss": "Missed the bubble",
  "playground.result.cancel": "Round exited",
