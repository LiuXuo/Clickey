const zh = {
  ...
  "status.pendingApplyErrorTitle": "当前改动尚未应用",
  "general.section": "通用",
  "general.title": "通用设置",
  ...
  "playground.section": "练习",
  "playground.title": "气泡点击练习",
  "playground.prompt.ready": "点击开始",
  "playground.prompt.active": "正在监听键盘",
  "playground.prompt.continue": "继续缩小区域",
  "playground.prompt.resume": "点击后继续本轮",
  "playground.result.success": "命中气泡",
  "playground.result.miss": "没有命中，再试一次",
  "playground.result.cancel": "本轮已退出",
  "layers.section": "层",
  "layers.title": "层编辑",
  ...
  "layers.stage0": "阶段 1",
  "layers.stage1": "阶段 2",
  "layers.removeConfirmTitle": "确认删除第 {index} 层？",
  "layers.removeConfirmHint":
    "删除后会立即重新应用当前配置；如果新配置不合法，页面顶部会保留失败原因。",
  "layers.removeConfirmAction": "确认删除",
  "hotkeys.section": "热键",
  "hotkeys.title": "按键绑定",
  "hotkeys.trigger": "激活",
